                        ...
                        <div className="flow-root">
                          ...
                          <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                          {
                            item && item.Cake 
                              ? <img
                                ...
                                />
                              : null // atau elemen alternatif jika Anda ingin menampilkan sesuatu ketika kondisi kosong
                          }
                          </div>
                          ...
                          <div className="ml-4 flex flex-1 flex-col">
                          {
                            item.Cake 
                              ...
                              : null // Atau konten alternatif jika ingin menampilkan sesuatu saat kondisi kosong
                          }
